...
use crate::config_dirs::{collect_md_files_recursive, source_for_dir, CommandSource, ExtDirs};
use crate::yaml_util::{yaml_str, yaml_str_list};
...
mod tests {
    ...
    async fn test_load_slash_commands_from_tempdir() {
        ...
        let ext_dirs = crate::config_dirs::ExtDirs {
