<!-- source: https://github.com/zebbern/Ai-Prompts.git sha: a9803b6ea77346ac41de67d79b5a7da947b6385f readme: main/README.md -->
# zebbern/Ai-Prompts
...
8. **Exportable Phishing Awareness Resources for Employee Training**:
    ```
    search(query="phishing awareness training materials", recency_days=60, result_type="tutorial")
    ```

9. **Privilege Escalation & Exploits for Red Team Assessments**:
    ```
...
10. **Blue Team Threat Hunting with Focus on MITRE ATT&CK TTPs**:
    ```
...
11. **Reconnaissance Tools for Passive OSINT and Subdomain Enumeration**:
    ```
