<!-- source: https://github.com/shibashisdas76/support-agent-openenv.git sha: 3ab8ec7af35ca094943d5a61603c24e1c104299c readme: main/README.md -->
# shibashisdas76/support-agent-openenv

Tier-1 AI Support Agent: Autonomous problem solver using Qwen LLM. Routes tickets, enforces SaaS policies via knowledge base search, and securely manages mock DB transactions (refunds) with Chain-of-Thought reasoning. Implements dynamic penalties, rewards, and Hinglish understanding.
