<!-- source: https://github.com/visionransom95/Hackathon-dev.git sha: 6e4e240ed9542a8aa3b95f25970fc16793b9e2f0 readme: main/README.md -->
# visionransom95/Hackathon-dev

A mobile-first AI chat application featuring multiple reasoning models (Hackathon-Flash, Hackathon-Pro, etc.), chain-of-thought visualization, and a polished user interface.
