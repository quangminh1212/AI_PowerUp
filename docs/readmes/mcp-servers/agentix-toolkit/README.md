<!-- source: https://github.com/skwijeratne/agentix-toolkit.git sha: 590cdbc1e72dd1524eefb66f4971ef853245ca02 readme: main/README.md -->
# skwijeratne/agentix-toolkit

A generic, batteries-included, async-first agent toolkit — configurable loop, tools, security guards, streaming, persistence, and MCP. Import as 'agentix'.
