<!-- source: https://github.com/xChechi/xche-ai-app-security-pack.git sha: d5031cc52d12bf9b2fdd02d1e0d30c15125e3c43 readme: main/README.md -->
# xChechi/xche-ai-app-security-pack

Free security guardrails for apps built with AI coding tools (Claude Code, Cursor, Lovable, Bolt). Drop-in rules + OWASP/LLM/MCP policy + secret-scanning hooks & CI gate.
