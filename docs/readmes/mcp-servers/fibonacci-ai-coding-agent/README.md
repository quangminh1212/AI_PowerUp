<!-- source: https://github.com/realrobotteam/fibonacci-AI-coding-agent.git sha: 16b398c8f49b238335e6a9ad2fab1ba89380f2db readme: main/README.md -->
# realrobotteam/fibonacci-AI-coding-agent

Autonomous coding agent as an SDK, IDE extension, or CLI assistant.Open-source AI coding agent with Plan/Act modes, MCP integration, and terminal-first workflows. Trusted by  developers worldwide.
