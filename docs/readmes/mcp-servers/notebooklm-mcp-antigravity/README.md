<!-- source: https://github.com/duykhanhbv-bit/notebooklm-mcp-antigravity readme: main/README.md -->
# duykhanhbv-bit/notebooklm-mcp-antigravity

> Submodule path: `mcp-servers/notebooklm-mcp-antigravity`
