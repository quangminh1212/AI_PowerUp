<!-- source: https://github.com/zarldev/zarl.git sha: b31f5178572701560e4a8f7231c12d94d32eb54c readme: main/README.md -->
# zarldev/zarl

Local-first multimodal AI assistant — single Go binary with embedded React frontend, talking to local inference servers for speech, vision, and LLM.

---

# Zarl

[![CI](https://github.com/zarldev/zarl/actions/workflows/ci.yml/badge.svg?branch=main)](https://github.com/zarldev/zarl/actions/workflows/ci.yml)
