<!-- source: https://github.com/senigami/audiobook-studio.pinokio.git sha: a91477b60ba19da0cffa5f5c8558ec9f5cfa18fa readme: main/README.md -->
# senigami/audiobook-studio.pinokio

Pinokio launcher for Audiobook Studio. Professional local-first AI production pipeline for long-form narration. Clone voices and generate studio-grade audiobooks (M4B/MP3) using Coqui XTTS-v2 and support for Voxtral (cloud)
