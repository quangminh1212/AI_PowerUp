<!-- source: https://github.com/scwf/open-dubbing.git sha: c4004e681294b67637dfc564988e494c5666cb0b readme: main/README.md -->
# scwf/open-dubbing

🎙️ AI Dubbing Tool - Professional Voice Cloning & Synchronization:   Transform your subtitles into high-quality dubbed audio using cutting-edge TTS models. 
...
```bash
python ai_dubbing/validate_durations.py "subtitles/movie.srt"
```
