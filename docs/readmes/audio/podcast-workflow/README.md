<!-- source: https://github.com/questionjie-max/podcast-workflow.git sha: a0cb51ec25b1baacbac6213023154d048cfa2ac7 readme: main/README.md -->
# questionjie-max/podcast-workflow

🎙️ AI Podcast Generator Claude Code Skill — Topic Research → Script Writing → Compliance Review → TTS Voice Synthesis. Powered by Xiaomi MiMo TTS with voice cloning & emotion matching. AI播客制作工作流：选题搜索 → 文稿撰写 → 合规审查 → TTS语音合成，支持声音克隆和情绪节奏匹配。
