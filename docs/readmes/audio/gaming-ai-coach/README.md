<!-- source: https://github.com/tejashah88/gaming-ai-coach.git sha: 1948bb2d04e9d6dbcf3afe68eae9cb818b1010fe readme: main/README.md -->
# tejashah88/gaming-ai-coach
...
> **Python 3.12 required.** Many compiled dependencies (e.g. `blis`, `spacy`, `numba`) don't have pre-built wheels for Python 3.13+, causing source builds to fail. If you have multiple Python versions installed, use the [Python Launcher for Windows](https://docs.python.org/3/using/windows.html#python-launcher-for-windows) (`py`) to target the right one: `py -3.12 --version`. The setup scripts already handle this automatically.
...
Here's a few starting resources for making your own voice clones. Use them responsibly!
  ...
  * [Aiartes - VoiceAI](https://aiartes.com/voiceai)
