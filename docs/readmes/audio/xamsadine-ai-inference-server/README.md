<!-- source: https://github.com/utachicodes/xamsadine-ai-inference-server.git sha: b3f3b3ab8ddd6b0fdf20f739d0ead97614f28744 readme: main/README.md -->
# utachicodes/xamsadine-ai-inference-server

A core component of Xamsadine AI that processes voice-based queries using WAV audio files. This server enables the chatbot to understand spoken queries via a REST API. Dockerized for easy deployment
