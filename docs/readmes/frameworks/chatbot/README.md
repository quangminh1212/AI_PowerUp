<!-- source: https://github.com/NizamuddinMandekar/ChatBot.git sha: d5f2a0323936e9cd4b8ac24269db365273dfd1b7 readme: main/README.md -->
# NizamuddinMandekar/ChatBot

This repository contains a small yet smart chatbot designed to facilitate NLP & Conversational Ai interactions. In summary, this script seems to be a part of a larger system for building a conversational AI chatbot that can answer questions based on provided contexts, particularly from PDF documents, utilizing Langchain and Google Generative AI.
