<!-- source: https://github.com/sabbirhosen44/CodeIDE-Frontend.git sha: 935f105abee25ca1728ac9f02a87e336d8be88a1 readme: main/README.md -->
# sabbirhosen44/CodeIDE-Frontend

CodeIDE is a browser-based IDE built with React, TypeScript, and Monaco Editor. It features a code editor with customizable settings, an AI coding assistant, project templates, and authentication. Responsive and intuitive, it connects to a backend for robust functionality. Backend  repo link : https://github.com/sabbirhosen44/CodeIDE-Backend
