<!-- source: https://github.com/Nayann23/AI-Chat_integrated.git sha: 5013cb448b783172570f7cf945ad7d3cdb95d2d5 readme: main/README.md -->
# Nayann23/AI-Chat_integrated

A full-stack, real-time chat application built with the MERN stack. Includes secure authentication, private messaging, typing indicators, and a built-in IDE. An AI assistant is integrated for coding help via @AI commands within the chat.

---

# 💬 AI-Integrated Chat App (MERN)  
