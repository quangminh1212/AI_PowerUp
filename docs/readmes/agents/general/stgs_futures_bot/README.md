<!-- source: https://github.com/alonecandies/stgs_futures_bot readme: main/README.md -->
# alonecandies/stgs_futures_bot

> Submodule path: `agents/general/stgs_futures_bot`
