<!-- source: https://github.com/Netxeo/skill-file-security.git sha: f6dd9e2d53c936c79af307766b0d8497e972062c readme: main/README.md -->
...
📦 Installing security-skill...
  ...
  ✅ .claude/commands/ created      ← Claude Code slash commands registered
...
| `/security-explain` | Explains a security rule or concept in plain language |
...
|---|---|
| Claude / Antigravity | `CLAUDE.md` + `.claude/commands/` (slash commands) |
