<!-- source: https://github.com/renefichtmueller/claude-code-hardened.git sha: d7cb77a91c8bcd300610fb564c108a22cd95fd9a readme: main/README.md -->
...
| **Private Network** | RFC 1918 addresses | `192.0.2.10`, `10.0.0.1`, `172.16.x.x` |
