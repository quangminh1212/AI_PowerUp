<!-- source: https://github.com/wadeKeith/Awesome-Embodied-AI.git sha: 5562bf823a21ea5b0306c24d0e7726e2c47d8a9b readme: main/README.md -->
...
[![Stars](https://img.shields.io/github/stars/wadeKeith/Awesome-Embodied-AI?style=flat-square)](https://github.com/wadeKeith/Awesome-Embodied-AI/stargazers)
[![Forks](https://img.shields.io/github/forks/wadeKeith/Awesome-Embodied-AI?style=flat-square)](https://github.com/wadeKeith/Awesome-Embodied-AI/network/members)
[![Last Commit](https://img.shields.io/github/last-commit/wadeKeith/Awesome-Embodied-AI?style=flat-square)](https://github.com/wadeKeith/Awesome-Embodied-AI/commits/main)
[![License](https://img.shields.io/github/license/wadeKeith/Awesome-Embodied-AI?style=flat-square)](LICENSE)
...
- New to the field: begin with [Surveys](#surveys).
- Looking for policy and model work: jump to [Brain Models](#brain-models) and [VLA Models](#vla-models).
- Building systems: use [Simulators](#simulators), [Datasets](#datasets), and [Toolkits](#toolkits).
- Evaluating deployment risk: read [Safety](#safety).

See [CONTRIBUTING.md](CONTRIBUTING.md) to add a paper, fix a link, or propose a new section. If this repo is useful, please star it and cite it.
...
- [Embodied AI and RL](#embodied-ai-and-rl)
- [Robotic Code as Policy](#robotic-code-as-policy)
- [Robotic In-Context Learning](#robotic-in-context-learning)
- [Interaction and Humanoids](#interaction-and-humanoids)
- [Safety](#safety)
...
- Deep Learning Approaches to Grasp Synthesis: A Review [[Paper Link]](https://arxiv.org/abs/2207.02556) [[Project Link]](https://rhys-newbury.github.io/projects/6dof/) [2023]
...
- [x] EquiDexFlow: Contact-Grounded SE(3)-Equivariant Dexterous Grasp Generative Flows [[Paper Link]](https://arxiv.org/abs/2606.12728) [[Project Link]](https://equidexflow.github.io) [2026]
...
- [x] RACER: Rich Language-Guided Failure Recovery Policies for Imitation Learning [[Paper Link]](https://arxiv.org/abs/2409.14674) [[Project Link]](https://github.com/sled-group/RACER) [2024]
...
- [ ] DoReMi: Grounding Language Model by Detecting and Recovering from Plan-Execution Misalignment [[Paper Link]](https://arxiv.org/abs/2307.00329) [[Project Link]](https://sites.google.com/view/doremi-paper) [2023]
...
- [ ] EWAM: An Enhanced World Action Model for Closed-Loop Online Adaptation in Embodied Intelligence [[Paper Link]](https://arxiv.org/abs/2606.12690) [2026]
- [ ] Action-Effect Memory Pretraining for Robot Manipulation [[Paper Link]](https://arxiv.org/abs/2606.12499) [2026]
- [ ] Foresight: Iterative Reasoning About Clues that Matter for Navigation [[Paper Link]](https://arxiv.org/abs/2606.12550) [[Project Link]](https://amrl.cs.utexas.edu/foresight) [2026]
...
- [x] Learning Fine-Grained Bimanual Manipulation with Low-Cost Hardware [[Paper Link]](https://arxiv.org/abs/2304.13705) [[Project Link]](https://tonyzhaozh.github.io/aloha/) [2023]
...
- [ ] Real-Time Execution with Autoregressive Policies [[Paper Link]](https://arxiv.org/abs/2606.13355) [2026]
...
- [ ] EmbodiSteer: Steering Embodiment-Agnostic Visuomotor Policies with Joint-Space Guidance for Zero-Shot Cross-Embodiment Deployment [[Paper Link]](https://arxiv.org/abs/2606.12965) [[Project Link]](https://frankwang67.github.io/EmbodiSteer-Page) [2026]
...
- [ ] muVLA: On Recurrent Memory for Partially Observable Manipulation in VLA Models [[Paper Link]](https://arxiv.org/abs/2606.12497) [[Project Link]](https://avanturist322.github.io/mu-vla/) [2026]
...
- [ ] LEGS: Fine-Tuning Teleop-Free VLAs for Humanoid Loco-manipulation in an Embodied Gaussian Splatting World [[Paper Link]](https://arxiv.org/abs/2606.01458) [[Project Link]](https://legsvla.github.io/) [2026]
- [x] ACoT-VLA: Action Chain-of-Thought for Vision-Language-Action Models [[Paper Link]](https://arxiv.org/abs/2601.11404) [[Project Link]](https://github.com/AgibotTech/ACoT-VLA) [2026]
- [x] DySL-VLA: Efficient Vision-Language-Action Model Inference via Dynamic-Static Layer-Skipping for Robot Manipulation [[Paper Link]](https://arxiv.org/abs/2602.22896) [[Project Link]](https://github.com/PKU-SEC-Lab/DYSL_VLA) [2026]
- [x] ActiveVLA: Injecting Active Perception into Vision-Language-Action Models for Precise 3D Robotic Manipulation [[Paper Link]](https://arxiv.org/abs/2601.08325) [[Project Link]](https://github.com/ZhenyangLiu/ActiveVLA-Injecting-Active-Perception-into-VLA) [2026]
- [x] WholeBodyVLA: Towards Unified Latent VLA for Whole-Body Loco-Manipulation Control [[Paper Link]](https://arxiv.org/abs/2512.11047) [[Project Link]](https://github.com/OpenDriveLab/WholebodyVLA) [2026]
- [ ] Guide, Think, Act: Interactive Embodied Reasoning in Vision-Language-Action Models [[Paper Link]](https://arxiv.org/abs/2605.13632) [[Project Link]](https://signalispupupu.github.io/GTA-VLA_ProjPage/) [2026]
- [ ] Towards Long-horizon Embodied Agents with Tool-Aligned Vision-Language-Action Models [[Paper Link]](https://arxiv.org/abs/2605.13119) [2026]
...
- [x] RVT: Robotic View Transformer for 3D Object Manipulation [[Paper Link]](https://arxiv.org/pdf/2306.14896) [[Project Link]](https://github.com/NVlabs/RVT) [2023]
...
- [ ] Revisiting Embodied Chain-of-Thought for Generalizable Robot Manipulation [[Paper Link]](https://arxiv.org/abs/2606.03784) [2026]
...
- [ ] Mana: Dexterous Manipulation of Articulated Tools [[Paper Link]](https://arxiv.org/abs/2606.13677) [[Project Link]](https://zhaohengyin.github.io/mana) [2026]
- [ ] See Selectively, Act Adaptively: Dual-Level Structural Decomposition for Bimanual Robot Manipulation [[Paper Link]](https://arxiv.org/abs/2606.13279) [2026]
...
- [ ] VICX: Generalizable Robot Manipulation via Video Generation and In-Context Operator Network [[Paper Link]](https://arxiv.org/abs/2606.12028) [[Project Link]](https://scaling-group.github.io/vicx/) [2026]
...
- [ ] ULTRA: Unified Multimodal Control for Autonomous Humanoid Whole-Body Loco-Manipulation [[Paper Link]](https://arxiv.org/abs/2603.03279) [[Project Link]](https://ultra-humanoid.github.io/) [2026]
- [x] SUGAR: A Scalable Human-Video-Driven Generalizable Humanoid Loco-Manipulation Learning Framework [[Paper Link]](https://arxiv.org/abs/2605.20373) [[Project Link]](https://tianshuwu.github.io/sugar-humanoid/) [2026]
- [x] OASIS: From Simulation Data Collection to Real-World Humanoid Loco-Manipulation [[Paper Link]](https://arxiv.org/abs/2606.08548) [[Project Link]](https://oasis-humanoid.github.io/) [2026]
- [ ] HumanoidMimicGen: Data Generation for Loco-Manipulation via Whole-Body Planning [[Paper Link]](https://arxiv.org/abs/2605.27724) [[Project Link]](https://humanoidmimicgen.github.io/) [2026]
...
- [x] Safety in Embodied AI: A Survey of Risks, Attacks, and Defenses [[Paper Link]](https://arxiv.org/abs/2605.02900) [[Project Link]](https://github.com/x-zheng16/Awesome-Embodied-AI-Safety) [2026]
- [ ] Safe Embodied AI for Long-horizon Tasks: A Cross-layer Analysis of Robotic Manipulation [[Paper Link]](https://arxiv.org/abs/2606.05660) [2026]
...
- [ ] Phantom of the ADAS: Securing advanced driver-assistance systems from split-second phantom attacks [[Paper Link]](https://arxiv.org/abs/1907.00374) [2020]
...
- [ ] Understanding Zero-Shot Adversarial Robustness for Large-Scale Models [[Paper Link]](https://arxiv.org/abs/2212.07016) [2023]
- [ ] AnyAttack: Towards Large-scale Self-supervised Adversarial Attacks on Vision-language Models [[Paper Link]](https://arxiv.org/abs/2408.09750) [2025]

**Auditory Perception** — voice command injection, audio adversarial examples, and defenses:

- [ ] Hidden voice commands [[Paper Link]](https://arxiv.org/abs/1708.09537) [2016]
- [ ] Devil's Whisper: A General Approach for Physical Adversarial Attacks against Commercial Black-box Speech Recognition Devices [[Paper Link]](https://arxiv.org/abs/2002.09765) [2020]
- [ ] SpecPatch: Human-in-the-loop adversarial audio spectrogram patch attack on speech recognition [[Paper Link]](https://arxiv.org/abs/2211.08145) [2022]
- [ ] TrojanModel: A practical trojan attack against automatic speech recognition systems [[Paper Link]](https://ieeexplore.ieee.org/document/10179331) [2023]
- [ ] Antifake: Using adversarial audio to prevent unauthorized speech synthesis [[Paper Link]](https://arxiv.org/abs/2304.01507) [2023]

**Spatial Perception** — LiDAR spoofing, point cloud attacks, and 3D perception robustness:

- [ ] Physically realizable adversarial examples for lidar object detection [[Paper Link]](https://arxiv.org/abs/2004.00543) [2020]
- [ ] Invisible for both Camera and LiDAR [[Paper Link]](https://arxiv.org/abs/2106.09249) [2021]
- [ ] Exorcising "Wraith": Protecting LiDAR-based Object Detector in Automated Driving System from Appearing Attacks [[Paper Link]](https://arxiv.org/abs/2303.12912) [2023]
- [ ] Adversary is on the Road: Attacks on Visual SLAM with Robust Perturbations on Point Clouds [[Paper Link]](https://www.usenix.org/conference/usenixsecurity24/presentation/chen-baodong) [2024]
- [ ] Towards Real-Time Defense against Object-Based LiDAR Attacks in Autonomous Driving [[Paper Link]](https://dl.acm.org/doi/10.1145/3666025.3699345) [2025]

**Motion Perception** — IMU/GPS/radar sensor spoofing and drone attacks:

- [ ] Rocking drones with intentional sound noise on gyroscopic sensors [[Paper Link]](https://www.usenix.org/conference/usenixsecurity15/technical-sessions/presentation/son) [2015]
- [ ] WALNUT: Waging doubt on the integrity of MEMS accelerometers with acoustic injection attacks [[Paper Link]](https://ieeexplore.ieee.org/document/7961948) [2017]
- [ ] Drift with Devil: Security of Multi-Sensor Fusion based Localization in Autonomous Driving under GPS Spoofing [[Paper Link]](https://arxiv.org/abs/2006.05543) [2020]
- [ ] mmSpoof: Resilient spoofing of automotive millimeter-wave radars using reflect array [[Paper Link]](https://ieeexplore.ieee.org/abstract/document/10179371) [2023]
- [ ] Paralyzing Drones via EMI Signal Injection on Sensory Communication Channels [[Paper Link]](https://arxiv.org/abs/2302.08997) [2023]

**Cross-Modal Perception** — attacks exploiting multi-sensor fusion inconsistencies:

- [ ] Security Analysis of Camera-LiDAR Fusion Against Black-Box Attacks on Autonomous Vehicles [[Paper Link]](https://arxiv.org/abs/2212.04064) [2022]
- [ ] Exploring Adversarial Robustness of LiDAR-Camera Fusion Model in Autonomous Driving [[Paper Link]](https://arxiv.org/abs/2301.07029) [2023]
- [ ] Malicious Attacks against Multi-Sensor Fusion in Autonomous Driving [[Paper Link]](https://dl.acm.org/doi/abs/10.1145/3636534.3649372) [2024]
- [ ] Beyond Attack Success Rate: Examining Trigger Leakage in Vision-Language Agentic Systems [[Paper Link]](https://arxiv.org/abs/2606.12586) [2026]
- [ ] Not What You Asked For: Typographic Attacks in Household Robot Manipulation [[Paper Link]](https://arxiv.org/abs/2605.18593) [2026]

### Cognition Safety

**Instruction Understanding** — attacks on embodied instruction following and VQA:

- [ ] SQA3D: Situated Question Answering in 3D Scenes [[Paper Link]](https://arxiv.org/abs/2210.07474) [2023]
- [ ] Can we trust embodied agents? Exploring backdoor attacks against embodied LLM-based decision-making systems [[Paper Link]](https://arxiv.org/abs/2405.20774) [2024]
- [ ] AGENTSAFE: Benchmarking the Safety of Embodied Agents on Hazardous Instructions [[Paper Link]](https://arxiv.org/abs/2506.14697) [2025]
- [ ] RoboSafe: Safeguarding Embodied Agents via Executable Safety Logic [[Paper Link]](https://arxiv.org/abs/2512.21220) [2025]

**World Model** — hallucination, robustness, and safety in learned world models:

- [ ] SafeDreamer: Safe Reinforcement Learning with World Models [[Paper Link]](https://arxiv.org/abs/2307.07176) [2024]
- [ ] Multi-Object Hallucination in Vision Language Models [[Paper Link]](https://arxiv.org/abs/2407.06192) [2024]
- [ ] Learning Latent Dynamic Robust Representations for World Models [[Paper Link]](https://arxiv.org/abs/2405.14953) [2024]
- [ ] Targeting World Models to Compromise Robot Learning Pipelines [[Paper Link]](https://arxiv.org/abs/2606.09499) [2026]

**Reasoning** — jailbreaking chain-of-thought and embodied reasoning:

- [ ] Do As I Can, Not As I Say: Grounding Language in Robotic Affordances [[Paper Link]](https://arxiv.org/abs/2204.01691) [2022]
- [ ] Inner Monologue: Embodied Reasoning through Planning with Language Models [[Paper Link]](https://arxiv.org/abs/2207.05608) [2022]
- [ ] Agent Smith: A Single Image Can Jailbreak One Million Multimodal LLM Agents Exponentially Fast [[Paper Link]](https://arxiv.org/abs/2402.08567) [2024]
- [ ] H-CoT: Hijacking the Chain-of-Thought Safety Reasoning Mechanism to Jailbreak Large Reasoning Models [[Paper Link]](https://arxiv.org/abs/2502.12893) [2025]

### Planning Safety

**Task Planning** — jailbreaking LLM planners and backdooring robotic task plans:

- [ ] Adversarial Attacks on Optimization based Planners [[Paper Link]](https://arxiv.org/abs/2011.00095) [2021]
- [ ] Jailbreaking LLM-controlled robots [[Paper Link]](https://arxiv.org/abs/2410.13691) [2024]
- [ ] BadRobot: Jailbreaking embodied LLMs in the physical world [[Paper Link]](https://arxiv.org/abs/2407.20242) [2024]
- [ ] HASARD: A Benchmark for Vision-Based Safe Reinforcement Learning in Embodied Agents [[Paper Link]](https://arxiv.org/abs/2503.08241) [2025]
- [ ] Robo-Troj: Backdoor Attacks Against Robotic Manipulation in the Physical World [[Paper Link]](https://arxiv.org/abs/2504.17070) [2025]

**Trajectory Planning** — adversarial scenarios for autonomous driving trajectory prediction:

- [ ] SafeBench: A Benchmarking Platform for Safety Evaluation of Autonomous Vehicles [[Paper Link]](https://arxiv.org/abs/2206.09682) [2022]
- [ ] On adversarial robustness of trajectory prediction for autonomous vehicles [[Paper Link]](https://arxiv.org/abs/2201.05057) [2022]
- [ ] AdvDo: Realistic adversarial attacks for trajectory prediction [[Paper Link]](https://arxiv.org/abs/2209.08744) [2022]
- [ ] Robust inverse constrained reinforcement learning under model misspecification [[Paper Link]](https://arxiv.org/abs/2407.07648) [2024]
- [ ] AdvDiffuser: Generating adversarial safety-critical driving scenarios via guided diffusion [[Paper Link]](https://arxiv.org/abs/2410.08453) [2024]

**Multi-Agent Planning** — Byzantine resilience and adversarial communication in swarms:

- [ ] Blockchain Technology Secures Robot Swarms: A Comparison of Consensus Protocols and Their Resilience to Byzantine Robots [[Paper Link]](https://www.frontiersin.org/journals/robotics-and-ai/articles/10.3389/frobt.2020.00054/full) [2020]
- [ ] The Emergence of Adversarial Communication in Multi-Agent Reinforcement Learning [[Paper Link]](https://arxiv.org/abs/2008.02616) [2021]
- [ ] Robot Swarms Neutralize Harmful Behaviors Through Cross-Referencing [[Paper Link]](https://www.science.org/doi/10.1126/scirobotics.abm4636) [2023]
- [ ] Adversarial Machine Learning Attacks and Defences in Multi-Agent Reinforcement Learning [[Paper Link]](https://arxiv.org/abs/2301.04299) [2024]

### Action and Interaction Safety

**Robot Control** — adversarial RL, backdoors in policies, and safe VLA models:

- [ ] Robust Adversarial Reinforcement Learning [[Paper Link]](https://arxiv.org/abs/1703.02702) [2017]
...
- [ ] Perceived Safety in Physical Human Robot Interaction -- A Survey [[Paper Link]](https://arxiv.org/abs/2105.14499) [2021]
- [ ] A Taxonomy of Factors Influencing Perceived Safety in Human-Robot Interaction [[Paper Link]](https://link.springer.com/article/10.1007/s12369-023-01027-8) [2023]
- [ ] PsySafe: A Comprehensive Framework for Psychological-based Attack, Defense, and Evaluation of Multi-agent System Safety [[Paper Link]](https://arxiv.org/abs/2401.11880) [2024]
- [ ] Embedding ISO 10218 Safety Compliance in Robots via Control Barrier Functions for Human-Robot Collaboration [[Paper Link]](https://arxiv.org/abs/2606.13203) [2026]

**Multi-Agent Collaboration** — inter-agent infection and collusion:

- [ ] When Autonomy Goes Rogue: Preparing for Risks of Multi-Agent Collusion in Social Systems [[Paper Link]](https://arxiv.org/abs/2507.14660) [2025]

### Agentic System Safety

**Tool Use** — prompt injection and skill poisoning in tool-using agents:

- [ ] RoboCodeX: Multimodal Code Generation for Robotic Behavior Synthesis [[Paper Link]](https://arxiv.org/abs/2402.16117) [2024]
- [ ] STAC: Stealthy and Targeted Attack on Code Agents [[Paper Link]](https://arxiv.org/abs/2509.25624) [2025]
- [ ] Prompt Injection Attack to Tool Selection in LLM Agents [[Paper Link]](https://arxiv.org/abs/2504.19793) [2025]
...
- [ ] Ghost of the Past: Identifying and Resolving Privacy Leakage of LLM's Memory Through Proactive User Interaction [[Paper Link]](https://arxiv.org/abs/2410.14931) [2025]
- [ ] Topology Matters: Measuring Memory Leakage in Multi-Agent LLMs [[Paper Link]](https://arxiv.org/abs/2512.04668) [2025]
- [ ] Just Ask: Curious Code Agents Reveal System Prompts in Frontier LLMs [[Paper Link]](https://arxiv.org/abs/2601.21233) [2026]

**Self-Evolving** — risks from self-improving and hallucinating agents:

- [ ] Agent-SafetyBench: Evaluating the Safety of LLM Agents [[Paper Link]](https://arxiv.org/abs/2412.14470) [2024]
- [ ] Embodied Red Teaming for Auditing Robotic Foundation Models [[Paper Link]](https://arxiv.org/abs/2411.18676) [2024]
- [ ] Your Agent May Misevolve: Emergent Risks in Self-evolving LLM Agents [[Paper Link]](https://arxiv.org/abs/2509.26354) [2025]

**Cascading Risks** — cross-layer failures, supply chain attacks, and system-level vulnerabilities:

- [ ] Spatiotemporal Attacks for Embodied Agents [[Paper Link]](https://arxiv.org/abs/2005.09161) [2020]
- [ ] Secure Robotics: Nexus of Safety, Trust, and Cybersecurity [[Paper Link]](https://dl.acm.org/doi/10.1145/3723050) [2024]
- [ ] SafeAgentBench: A Benchmark for Safe Task Planning of Embodied LLM Agents [[Paper Link]](https://arxiv.org/abs/2412.13178) [2024]
- [x] EmbodiedGovBench: A Benchmark for Governance, Recovery, and Upgrade Safety in Embodied Agent Systems [[Paper Link]](https://arxiv.org/abs/2604.11174) [[Project Link]](https://github.com/s20sc/embodied-gov-bench) [2026]
...
- [x] CLIPORT: What and Where Pathways for Robotic Manipulation [[Paper Link]](https://arxiv.org/pdf/2109.12098.pdf) [[Project Link]](https://github.com/cliport/cliport) [2021]
...
- [x] PhyScene: Physically Interactable 3D Scene Synthesis for Embodied AI [[Paper Link]](https://arxiv.org/abs/2404.09465.pdf) [[Project Link]](https://github.com/PhyScene/PhyScene) [2024]
...
- [x] BabyAI: A Platform to Study the Sample Efficiency of Grounded Language Learning [[Paper Link]](https://arxiv.org/pdf/1810.08272) [[Project Link]](https://github.com/mila-iqia/babyai) [2019]
...
- [x] GraspNet-1Billion: A Large-Scale Benchmark for General Object Grasping [[Paper Link]](https://openaccess.thecvf.com/content_CVPR_2020/papers/Fang_GraspNet-1Billion_A_Large-Scale_Benchmark_for_General_Object_Grasping_CVPR_2020_paper.pdf) [[Project Link]](https://graspnet.net/) [2020]
...
- [ ] SPARC: Reliable Spatial Annotations from Robot Demonstrations at Scale [[Paper Link]](https://arxiv.org/abs/2606.13497) [[Project Link]](https://intuitive-robots.github.io/sparc-labeling/) [2026]
- [ ] EgoEngine: From Egocentric Human Videos to High-Fidelity Dexterous Robot Demonstrations [[Paper Link]](https://arxiv.org/abs/2606.12604) [[Project Link]](https://egoengine.github.io) [2026]
- [ ] RoboProcessBench: Benchmarking Process-Aware Understanding in Vision-Language Robotic Manipulation [[Paper Link]](https://arxiv.org/abs/2606.13040) [[Project Link]](https://claru.ai/datasets/processbench-2026-roboprocessbench) [2026]
...
If this repo helps your work, please use the metadata in [CITATION.cff](CITATION.cff) or cite it as:
