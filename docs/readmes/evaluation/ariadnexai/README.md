<!-- source: https://github.com/skhanzad/AriadneXAI.git sha: 78b6560abd6eaacc6593ab2cef133aa2ac8f0ffa readme: main/README.md -->
# skhanzad/AriadneXAI

Project Ariadne is an Explainable AI (XAI) research tool designed to evaluate the Causal Faithfulness of LLM agents. While agents produce persuasive Chain-of-Thought (CoT) reasoning, these traces frequently act as post-hoc rationalizations rather than generative drivers of the model's output.
