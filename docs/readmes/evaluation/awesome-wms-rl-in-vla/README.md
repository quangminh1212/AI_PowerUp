<!-- source: https://github.com/whitbrunn/Awesome-WMs-RL-in-VLA.git sha: 0a660149324aa4f54eb629b0f3541675cd5e4918 readme: main/README.md -->
# whitbrunn/Awesome-WMs-RL-in-VLA

This repo is a curated list of tech report, research papers, datasets, benchmarks, insights, toolkits and resources related to World Models (WMs) and Reinforcement Learning (RL) in Visual Language Agents (VLA)! The focus will especially be on the domain of embodied AI and Robotics.
