<!-- source: https://github.com/pniket7/Creating-a-Multi-Turn-QA-Conversational-chatbot-using-Langchain-and-OpenAI-API.git sha: 97252cda050e28694628f09c7c8b4479760bba35 readme: main/README.md -->
# pniket7/Creating-a-Multi-Turn-QA-Conversational-chatbot-using-Langchain-and-OpenAI-API

Conversational AI Bot is designed using the LangChain library and OpenAI API. The bot is designed to answer user questions based on content from a provided PDF document and maintain context through a simple memory mechanism.
