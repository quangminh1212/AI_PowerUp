<!-- source: https://github.com/tigusigalpa/monica-ai-php.git sha: afb8656520bc89043eb1ef89edc156787a415065 readme: main/README.md -->
...
[![Latest Version](https://img.shields.io/github/v/release/tigusigalpa/monica-ai-php)](https://github.com/tigusigalpa/monica-api-php/releases)
...
A powerful and elegant PHP client (SDK) library for [Monica API Platform](https://platform.monica.im/) - your unified
gateway
...
```bash
composer require tigusigalpa/monica-ai-php
```
...
- [GitHub Repository](https://github.com/tigusigalpa/monica-ai-php)
- [Packagist](https://packagist.org/packages/tigusigalpa/monica-ai-php)
...
2. Search existing [GitHub issues](https://github.com/tigusigalpa/monica-ai-php/issues)
