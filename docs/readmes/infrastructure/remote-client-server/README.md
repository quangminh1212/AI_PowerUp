<!-- source: https://github.com/SEMOSS/remote-client-server.git sha: a2447696048c4267a460ca89065c05aab679551e readme: master/README.md -->
# SEMOSS/remote-client-server

FastAPI application that supports HTTP clients used to serve different gen-AI models that require a GPU for inference.
