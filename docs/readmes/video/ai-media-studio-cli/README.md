<!-- source: https://github.com/Abdulrahman-Elsmmany/ai-media-studio-cli.git sha: 2b5e2fdbff56faf952637414634aa6607ac1c59f readme: main/README.md -->
# Abdulrahman-Elsmmany/ai-media-studio-cli
...
<img alt="AI Media Studio CLI — multi-modal AI media generation (Veo 3 video · Imagen images · MusicLM audio)" src="./assets/thumbnail-dark.png" width="100%">
...
<img alt="AI Media Studio Architecture — three interfaces converging on a Studio Core that routes to Veo, Imagen, MusicLM" src="./assets/architecture-art-dark.png" width="100%">

Three input interfaces (Desktop GUI · CLI · REST API) converge on a single Studio Core (prompt parser · model router · job queue) that fans out to three Google AI model families.
