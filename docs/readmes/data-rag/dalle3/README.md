<!-- source: https://github.com/Srijan-D/DALLE3.git sha: dc641afcc31c99aef288fe3351a0cd509b88bdff readme: main/README.md -->
# Srijan-D/DALLE3

Serverless AI art gallery using openAI's new DALLE3 api for auto image generation and gpt turbo model for suggesting image prompts. Azure infrastructure for serverless deployment of cloud functions along with microsoft azure blob storage for storage and retrieval of images.
