<!-- source: https://github.com/alphapro-club/Launch.git sha: c7ebce0c0f6f5b016f48d1484740191622691fb7 readme: main/README.md -->
# alphapro-club/Launch

Launching the "Agent Creation Toolkit", providing developers with an intuitive and efficient Development Environment, supporting the rapid construction of intelligent agents. The toolkit will integrate RAG (Retrieval-Augmented Generation) Knowledge Base and LLMOps toolchain.

---

<p align="center">
  <img src="https://raw.githubusercontent.com/aiflow/Launch/main/next/public/banner.png" height="300" alt="Launch Logo"/>
</p>
<p align="center">
...
<p align="center">
    <img alt="Node version" src="https://img.shields.io/static/v1?label=node&message=%20%3E=18&logo=node.js&color=2334D058" />
      <a href="https://github.com/AIFlow-agent/Launch/blob/master/README.md"><img src="https://img.shields.io/badge/lang-English-blue.svg" alt="English"></a>
  <a href="https://github.com/AIFlow-agent/Launch/blob/master/docs/README.zh-HANS.md"><img src="https://img.shields.io/badge/lang-简体中文-red.svg" alt="简体中文"></a>
  <a href="https://github.com/AIFlow-agent/Launch/blob/master/docs/README.hu-Cs4K1Sr4C.md"><img src="https://img.shields.io/badge/lang-Hungarian-red.svg" alt="Hungarian"></a>
</p>

<p align="center">
<a href="https://aiflow.aiflow.guru">🔗 Short link</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://docs.aiflow.guru/">📚 Docs</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://docs.aiflow.guru/essentials/contributing">🤝 Contribute</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://twitter.com/aiflowai">🐦 Twitter</a>
<span>&nbsp;&nbsp;•&nbsp;&nbsp;</span>
<a href="https://discord.gg/gcmNyAAFfV">📢 Discord</a>
</p>

Launch allows you to configure and deploy Autonomous AI agents.
...
The easiest way to get started with Launch is automatic setup CLI bundled with the project.
The cli sets up the following for Launch:
- 🔐 [Environment variables](https://github.com/AIFlow-agent/Launch/blob/main/.env.example) (and API Keys)
- 🗂️ [Database](https://github.com/AIFlow-agent/Launch/tree/main/db) (Mysql)
- 🤖 [Backend](https://github.com/AIFlow-agent/Launch/tree/main/platform) (FastAPI)
- 🎨 [Frontend](https://github.com/AIFlow-agent/Launch/tree/main/next) (Nextjs)
...
3. **Clone the Repository and Navigate into the Directory** - Once your terminal is open, you can clone the repository and move into the directory by running the commands below.
   ...
   **For Mac/Linux users** :apple: :penguin:
   ```bash
   git clone https://github.com/AIFlow-agent/Launch.git
   cd Launch
   ./setup.sh
   ```
...
our [public roadmap](https://docs.aiflow.guru/essentials/roadmap).
...
<p align="center">
Join us in fueling the development of Launch, an open-source project pushing the boundaries of AI agents! Your sponsorship would drive progress by helping us scale up resources, enhance features and functionality, and continue to iterate on this exciting project! 🚀
</p>
...
<a href="https://github.com/AIFlow-agent/aiflow/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=aiflow/aiflow" />
</a>
