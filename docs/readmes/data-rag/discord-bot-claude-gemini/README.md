<!-- source: https://github.com/llegomark/discord-bot-claude-gemini.git sha: 9d34371e037457f2b7f45fb41724186509ef711b readme: main/README.md -->
# llegomark/discord-bot-claude-gemini

This Discord bot leverages the Anthropic Claude and Google Gemini APIs to deliver dynamic conversational experiences. Powered by Anthropic's advanced Claude models and Google's robust Gemini language models, the bot can respond to user messages, maintain conversation history, and execute various commands.
