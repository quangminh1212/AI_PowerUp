...
#
# Usage:
#   pwsh -File _submodules\scripts\fetch_readmes.ps1
#   pwsh -File _submodules\scripts\fetch_readmes.ps1 -DryRun     # only print plan, no downloads
#   pwsh -File _submodules\scripts\fetch_readmes.ps1 -Max 20     # cap for testing
